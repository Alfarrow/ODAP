...
class _AckermannCtrlr(object):
    ...
    def __init__(self):
        ...
        # Obtener los parámetros de las llantas
        ...
        # Crear un cliente que reciba los controladores
        ...
        print("cmd_timeout= ", self._cmd_timeout)

        # Obtener frecuencia de publicación
        ...
        print("Frecuencia de publicación= ", pub_freq)

        # Obtener y declarar parámetros iniciales (excepto quizá _last_cmd_time o sea el de abajo)
...
#!!MODIFICADO
    ...
    def ackermann_cmd_cb(self, ackermann_cmd):
        ...
        # print("Órdenes Recibidas")

    def _get_front_wheel_params(self, side):
        # Obtén los parámetros de la rueda delantera. 
        # Devuelve una tupla que contiene el nombre del enlace de dirección, el nombre del controlador de dirección, 
        # el nombre del controlador del eje (o None) y el inverso de la circunferencia.
        print("Parámetros de Llantas Frontales Recibidos")
    ...
    def _get_rear_wheel_params(self, side):
        # Obtener los parámetros de la rueda trasera. 
        # Devuelve una tupla que contiene el nombre del enlace, el nombre del controlador del eje 
        # y el inverso de la circunferencia.
        print("Parámetros de LLantas Traseras Recibidas")
    ...
    def _get_common_wheel_params(self, prefix):
        # Obtener los parámetros utilizados por las ruedas delanteras y traseras. 
        # Devuelve una tupla que contiene el nombre del controlador del eje (o None) y el inverso de la circunferencia.
        ...
        print("Controlador e Inversa Obtenidos")

        return axle_ctrlr_name, 1 / (pi * dia)

    def _get_link_pos(self, tfl, link):
        #Devuelve la posición del enlace especificado, en relación al enlace de la rueda trasera derecha.
    ...
    # Parámetros predeterminados por si no se especifica nada (creo)
...
def _wait_for_ctrlr(list_ctrlrs, ctrlr_name):
    # Espera a que el controlador especificado esté en el estado "running" (en ejecución). 
    # Los comandos pueden perderse si se publican antes de que su controlador esté en ejecución, 
    # incluso si se utiliza un publicador "latched".
        ...
        for ctrlr in response.controller:
            if ctrlr.name == ctrlr_name:
                if ctrlr.state == "running":
                    print(f"Controlador {ctrlr_name} en Running")
                    return
                rospy.sleep(0.1)
                break
...
def _create_axle_cmd_pub(list_ctrlrs, axle_ctrlr_name):
    ...
    if not axle_ctrlr_name:
        print("No existe controlador de llanta")
        return None
...
def _create_cmd_pub(list_ctrlrs, ctrlr_name):
    ...
    _wait_for_ctrlr(list_ctrlrs, ctrlr_name)
    print(f"Publicador {ctrlr_name} creado")
